#!/usr/bin/env sh
# Universal installer for cspbuilder. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cspbuilder.git"
echo "Installing cspbuilder ..."
