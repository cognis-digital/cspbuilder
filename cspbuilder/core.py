"""CSPBUILDER core — Generate and audit a Content-Security-Policy from a page's resources."""
...
RULES = [
    ("CSP-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("CSP-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("CSP-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
