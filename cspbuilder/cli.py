...
import argparse, sys
from cspbuilder.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="cspbuilder", description="CSPBUILDER — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from cspbuilder.mcp_server import serve
        return serve()
    if args.cmd == "scan":
