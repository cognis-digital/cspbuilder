"""Native cognis-connect emit for cspbuilder — forward findings to any platform.

Maps cspbuilder's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    cspbuilder ... --format json | cspbuilder-emit --to stix
    cspbuilder-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
