...
[![PyPI](https://img.shields.io/pypi/v/cognis-cspbuilder.svg)](https://pypi.org/project/cognis-cspbuilder/)
[![CI](https://github.com/cognis-digital/cspbuilder/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/cspbuilder/actions)
...
CSPBUILDER exists for one job — generate and audit a content-security-policy from a page's resources — and does it without a SaaS bill or heavyweight setup.
...
```bash
cspbuilder --version
cspbuilder scan .                      # scan the current project
cspbuilder scan . --format json
cspbuilder scan . --fail-on high       # non-zero exit for CI gates
cspbuilder mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **csp-evaluator**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`cspbuilder` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
